...
/** @type {string} */
const CACHE_VERSION = '1784666487|395547262';
/** @type {string} */
const CACHE_PREFIX = 'Alcanzalos Huesi-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'alcanzalos_huesitos.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["alcanzalos_huesitos.html","alcanzalos_huesitos.js","alcanzalos_huesitos.offline.html","alcanzalos_huesitos.icon.png","alcanzalos_huesitos.apple-touch-icon.png","alcanzalos_huesitos.audio.worklet.js","alcanzalos_huesitos.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["alcanzalos_huesitos.wasm","alcanzalos_huesitos.pck"];
